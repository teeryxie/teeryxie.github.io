...
## What the benchmark emphasizes

- Audio-visual alignment in social scenes.
- Interaction understanding beyond static object recognition.
- Practical evaluation for omni models that claim broad multimodal capability.
- Dataset and code artifacts that make the benchmark easy to inspect and reuse.

## Links

- [arXiv](https://arxiv.org/abs/2603.16859)
- [Code](https://github.com/MAC-AutoML/SocialOmni)
- [Dataset](https://huggingface.co/datasets/alexisty/SocialOmni)
